...
pref-use-babeldoc =
    .label = Use BabelDOC (Recommended)
pref-use-babeldoc-description = BabelDOC provides better PDF layout preservation and translation quality. Install first: uv tool install --python 3.12 BabelDOC
pref-babeldoc-path = BabelDOC Path
pref-babeldoc-path-description = Default is "babeldoc". Specify full path if not in PATH
pref-custom-provider = API Provider
pref-custom-apikey = API Key
pref-custom-model = Model Name (Optional)
pref-custom-model-description = Leave empty to use default model. OpenAI recommended: gpt-4o-mini, DeepSeek recommended: deepseek-chat
